...
\section{Introduction} \label{sec:introduction}
	...
	\subsection{Research Questions}
		...
		\begin{itemize}
			...
			\item [\textbf{RQ3:}] How can we test and validate the use of prefabs to define hyperconverged/HPC datacenter topologies?
		\end{itemize}
...
\section{Evaluation of Design \& Implementation} \label{sec:evaluation}
	...
	Then, using a specific domain as an example, we define a systemic approach to creating prefabs from existing OEM offerings in this domain, as per \textbf{RQ3}.
	Lastly, we use a popular Human Computer Interaction model to assess the success of the implmented operations on prefabs, as per \textbf{RQ2}.
				...
				\begin{lstlisting}[language=json]
{
	...
	\subsection{Evaluating the Implementation}
		...
		For the purposes of our comparison, we will use the \textit{Keystroke-Level Model} (KLM) \cite{Newell1980} to test the duration of executing a specific task.
...
\section{Conclusion} \label{sec:conclusion}
	\subsection{Summary}
		...
		The datastructure presented provides a hierarchical organisational structure, in which components have a clear and logical place. 
		easily extensible, supporting future work both in terms of the capabilities of \opendc{}, and in terms of server design.
		In addition, we have also validated our work against existing server hardware from a specific domain, and proposed a method for doing so in other domains.
