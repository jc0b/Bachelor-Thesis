...
\section{Introduction} \label{sec:introduction}
	...
	\subsection{Problem}
		...
		If the workload relies on homogeneous nodes, these nodes can be defined as prefabs, and added into the design as needed for capacity testing.
...
\section{A Design for a Representation of Data Center Hardware} \label{sec:design}
	...
	\subsection{A Definition and Design of a Datastructure for Storing Prefabs}
		...
		The support for nested objects is crucial to us in order to achieve some of our functional requirements, namely \textbf{FR1} and \textbf{FR2}, as it allows for easier insertion into the object.
